...
describe('validator', () => {
    ...
    test('should return true when isValidObject is provided valid object with no nullable props', () => {
        ...
        // Act
        let result1 = isValidObject(new Wax(1, 'name', 'brand', 'category', 0.50, true, 5, 'Blank Description'));
        let result2 = isValidObject(new User(1, 'username', 'password', 'first', 'last', 'role'));
        let result3 = isValidObject(new Brand(1, 'brandName'));
        let result4 = isValidObject(new Owned(1, 1, 'product', 'brand', 'category', 0.50, true, 2, 5, 4, 'description'));
    ...
    test('should return true when isValidObject is provided valid object with nullable prop(s)', () => {
        ...
        // Act
        let result1 = isValidObject(new Wax(1, 'name', 'brand', 'category', 0.50, true, 5, 'Blank Description'), 'id', 'scentStrength', 'description');
        let result2 = isValidObject(new User(0, 'username', 'password', 'first', 'last', 'role'), 'id');
        let result3 = isValidObject(new Brand(1, 'brandName'), 'id');
        let result4 = isValidObject(new Owned(1, 1, 'product', 'brand', 'category', 0.50, true, 2, 5, 4, 'description'), 'id', 'personalRating', 'scentStrength', 'description');
    ...
    test('should return false when isValidObject is provided invalid object with no nullable prop(s)', () => {
        ...
        // Act
        let result1 = isValidObject(new Wax(1, '', 'brand', 'category', 0.50, true, 5, 'Blank Description'));
        let result2 = isValidObject(new User(0, '', 'password', 'first', 'last', 'role'));
        let result3 = isValidObject(new Brand(1, ''));
        let result4 = isValidObject(new Owned(1, 1, '', 'brand', 'category', 0.50, true, 2, 5, 4, 'description'));
    ...
    test('should return false when isValidObject is provided invalid object with some nullable prop(s)', () => {
        ...
        // Act
        let result1 = isValidObject(new Wax(1, '', 'brand', 'category', 0.50, true, 5, 'Blank Description'), 'id', 'scentStrength', 'description');
        let result2 = isValidObject(new User(0, '', 'password', 'first', 'last', 'role'), 'id');
        let result3 = isValidObject(new Brand(1, ''), 'id');
        let result4 = isValidObject(new Owned(1, 1, '', 'brand', 'category', 0.50, true, 2, 5, 4, 'description'), 'id', 'personalRating', 'scentStrength', 'description');
    ...
    test('should return true when isPropertyOf is provided a known property of a given constructable type', () => {
        ...
        let result3 = isPropertyOf('brand', Wax);
        let result4 = isPropertyOf('quantity', Owned);
        let result5 = isPropertyOf('brandName', Brand);
    ...
    test('should return false when isPropertyOf is provided a unknown property of a given constructable type', () => {
        ...
        let result3 = isPropertyOf('bran', Wax);
        let result4 = isPropertyOf('quantiy', Owned);
        let result5 = isPropertyOf('brandame', Brand);
